...
import { eventHandler, setHeaders, sendRedirect, proxyRequest, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, setResponseStatus, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'h3';
...
const _assets = {
  ["server:style.css"]: {
    import: () => import('./chunks/raw/style.mjs').then(r => r.default || r),
    meta: {"type":"text/css; charset=utf-8","etag":"\"15d0c-3c05eeqCbEj3LOjEU+vUHly16Iw\"","mtime":"2023-08-12T02:22:46.017Z"}
  }
};
